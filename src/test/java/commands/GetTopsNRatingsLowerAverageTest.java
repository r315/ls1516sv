 ...
 */
public class GetTopsNRatingsLowerAverageTest {
    @Before
    ...
    @Test
    public void GetTopsNRatingsLowerAverageExecute()throws Exception{
    ...
    @Test
    public void GetTopsNRatingsLowerAverageExecute_skip()throws Exception{
        Collection<String> title = new ArrayList<>();
        ArrayList<ArrayList<String>> data = new ArrayList<>();
    ...
    @Test
    public void GetTopsNRatingsLowerAverageExecute_top()throws Exception{
        Collection<String> title = new ArrayList<>();
        ArrayList<ArrayList<String>> data = new ArrayList<>();
    ...
    @Test
    public void GetTopsNRatingsLowerAverageExecute_skipTop()throws Exception{
        Collection<String> title = new ArrayList<>();
        ArrayList<ArrayList<String>> data = new ArrayList<>();
    ...
    public void GetTopsNRatingsLowerAverageExecute_invalidN()throws Exception{
        HashMap<String, String> param = new HashMap<>();
        param.put("n","-1");
    ...
    @Test(expected= InvalidCommandVariableException.class)
    public void GetTopsNRatingsLowerAverageExecute_nIsntNumber()throws Exception{
        HashMap<String, String> param = new HashMap<>();
        param.put("n","one");
